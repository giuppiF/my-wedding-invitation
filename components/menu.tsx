          ...
          <div className="flex items-center flex-1">
            <div className="flex items-center justify-between w-full lg:w-auto">
              ...
              <div className="-mr-2 flex items-center lg:hidden">
                <Popover.Button className="bg-red-500 rounded-md p-2 inline-flex items-center justify-center text-gray-100 hover:bg-gray-500 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white">
        ...
        >
          <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
            <div className="px-5 pt-4 flex items-center justify-between">
              ...
              <div className="-mr-2">
                <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500">
